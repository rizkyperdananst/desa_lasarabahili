...
@section('title', 'Admin | Tambah Kematian')
                    ...
                    <form action="{{ route('kematian.store') }}" method="POST">
                         ...
                         <div class="row mb-3">
                              ...
                              <div class="col-md-6">
                                   ...
                                   <input type="date" name="tanggal_kematian" id="tanggal_kematian" class="form-control @error('tanggal_kematian') is-invalid @enderror" placeholder="masukkan tanggal kematian">
                         ...
                         <div class="row mb-3">
                              <div class="col-md-6">
                                   ...
                                   <input type="text" name="tempat_kematian" id="tempat_kematian" class="form-control @error('tempat_kematian') is-invalid @enderror" placeholder="masukkan tempat kematian">
                              ...
                              <div class="col-md-6">
                                   ...
                                   <input type="text" name="penyebab_kematian" id="penyebab_kematian" class="form-control @error('penyebab_kematian') is-invalid @enderror" placeholder="masukkan penyebab kematian">
