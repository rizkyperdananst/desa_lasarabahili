...
@section('title', 'Admin | Kelahiran Kematian')
                    ...
                    <form action="{{ route('kelahiran.store') }}" method="POST">
                         ...
                         <div class="row mb-3">
                              <div class="col-md-6">
                                   ...
                                   <input type="text" name="nama_ayah" id="nama_ayah" class="form-control @error('nama_ayah') is-invalid @enderror" placeholder="masukkan nama ayah">
                                   @error('nama_ayah')
                                       <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                                   @enderror
                              </div>
                              <div class="col-md-6">
                                   ...
                                   <input type="text" name="nama_ibu" id="nama_ibu" class="form-control @error('nama_ibu') is-invalid @enderror" placeholder="masukkan nama ibu">
                                   @error('nama_ibu')
                                       <div class="alert alert-danger mt-2 mb-2 p-2">{{ $message }}</div>
                                   @enderror
                              </div>
